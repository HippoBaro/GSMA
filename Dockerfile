...
ENV DEPENDENCIES_SHADOWSOCKS git-core gettext build-essential autoconf apt-utils automake libtool libssl-dev libpcre3-dev asciidoc xmlto zlib1g-dev libev-dev libudns-dev libsodium-dev libmbedtls-dev ca-certificates
...
# Install libsodium
#RUN git clone https://github.com/jedisct1/libsodium -b stable $BASEDIR_LIBSODIUM
